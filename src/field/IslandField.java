...
public class IslandField {
    private Location[][] locations; // Двумерный массив состоящий из ячеек
    ...
    public synchronized List<Animal> getAllAnimals() {
        ...
        return allAnimals; // Возвращает список всех животных на острове
    }
    ...
    public List<Plant> getAllPlants() {
        ...
        return allPlants;// Возвращает список всех растений на острове
    }
